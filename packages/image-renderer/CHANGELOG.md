...
- Updated dependencies [048c41c]
  - @shipload/item-renderer@1.0.0-next.75
  - @shipload/sdk@1.0.0-next.75

## 1.0.0-next.74

### Patch Changes

- f1819a2: - Preflight platform fund collection in oracle maintenance
  - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  - Mirror the ranked ballot in the SDK and page the oracle settlement
...
- Updated dependencies [f1819a2]
  - @shipload/item-renderer@1.0.0-next.74
  - @shipload/sdk@1.0.0-next.74

## 1.0.0-next.73

### Patch Changes

- 4cbe0dd: - Preflight platform fund collection in oracle maintenance
  - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  - Mirror the ranked ballot in the SDK and page the oracle settlement
...
- Updated dependencies [4cbe0dd]
  - @shipload/item-renderer@1.0.0-next.73
  - @shipload/sdk@1.0.0-next.73

## 1.0.0-next.72

### Patch Changes

- c11efbb: - Resync the catalog and resolve capacity formulas from it
  - Preflight platform fund collection in oracle maintenance
  - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  ...
  - Route job cancellation through the ship or cancelcraft from one helper
  - Book Workshop jobs without a socket and read the window receipt
  - Add SDK fund ledger readers and beneficiary claim helper
  - Drop the job migration actions from the bindings
- Updated dependencies [c11efbb]
  - @shipload/item-renderer@1.0.0-next.72
  - @shipload/sdk@1.0.0-next.72

## 1.0.0-next.71

### Patch Changes

- 684487d: - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  - Mirror the ranked ballot in the SDK and page the oracle settlement
  - Inline the base tsconfig into every package
...
- Updated dependencies [684487d]
  - @shipload/item-renderer@1.0.0-next.71
  - @shipload/sdk@1.0.0-next.71

## 1.0.0-next.70

### Patch Changes

- b66c66f: - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  - Mirror the ranked ballot in the SDK and page the oracle settlement
  - Inline the base tsconfig into every package
...
- Updated dependencies [b66c66f]
  - @shipload/item-renderer@1.0.0-next.70
  - @shipload/sdk@1.0.0-next.70
...
- Updated dependencies [69daba4]
  - @shipload/item-renderer@1.0.0-next.68
  - @shipload/sdk@1.0.0-next.68

## 1.0.0-next.67

### Patch Changes

- fc96e1a: - Format the oracle race classifier test
  - Treat a lost reveal race as a normal beacon outcome
  - Close an overdue epoch from the oracle beacon tick
  - Mirror the ranked ballot in the SDK and page the oracle settlement
  - Inline the base tsconfig into every package
...
- Updated dependencies [fc96e1a]
  - @shipload/item-renderer@1.0.0-next.67
  - @shipload/sdk@1.0.0-next.67

## 1.0.0-next.66

### Patch Changes

- 0205fb5: - Read mass units in the CLI and item renderer
...
- Updated dependencies [ac779bb]
- Updated dependencies [0205fb5]
  - @shipload/sdk@1.0.0-next.66
  - @shipload/item-renderer@1.0.0-next.66

## 1.0.0-next.65

### Patch Changes

- 71ea595: - Gate the oracle maintenance sweeps on contract reads
  - Add the voteready ballot settlement tick
  - Add mintready, charterready and tend heartbeat ticks
  - Multi-oracle epoch system
  - Add script to preseed secret
...
- Updated dependencies [71ea595]
  - @shipload/item-renderer@1.0.0-next.65
  - @shipload/sdk@1.0.0-next.65
...
- Updated dependencies [6f1c96a]
  ...
  - @shipload/item-renderer@1.0.0-next.64

## 1.0.0-next.63

### Patch Changes

- 12e7a13: - Add the voteready ballot settlement tick
  - Add mintready, charterready and tend heartbeat ticks
  - Multi-oracle epoch system
  - Add script to preseed secret
  - Update Dockerfile
...
- Updated dependencies [12e7a13]
  - @shipload/item-renderer@1.0.0-next.63
  - @shipload/sdk@1.0.0-next.63
...
- Updated dependencies [7d3c737]
  - @shipload/item-renderer@1.0.0-next.62
  - @shipload/sdk@1.0.0-next.62

## 1.0.0-next.61

### Patch Changes

- 0c103cc: - Multi-oracle epoch system
  - Add script to preseed secret
  - Update Dockerfile
  - Migrated shipload/oracle into toolkit
  - Sync the Cargo Hold and Battery Bank T2 module catalog and SDK mirror
  - Mirror module tier slopes in the SDK and sync the Engine and Generator T2 catalog
  - Scale gatherer yield with module tier
  - Adopt the stride-1000 item id scheme
  - Resolve entity base capacity from the entity kind
  - Mirror the contract entity capacity dispatch and tonne mass formatting
  - Resolve entity display names from the kind registry
  - Sync the workshop craft recipe catalog
- Updated dependencies [0c103cc]
  - @shipload/item-renderer@1.0.0-next.61
  - @shipload/sdk@1.0.0-next.61
...
- Updated dependencies [10bcdb0]
  - @shipload/item-renderer@1.0.0-next.60
...
- 577061a: - Mirror the roster ladder adoption in the SDK and item-renderer
  - Multi-oracle epoch system
  - Add script to preseed secret
  - Update Dockerfile
  - Migrated shipload/oracle into toolkit
  - Batch and dedupe counterpart fetches in the craft incoming preflight
  - Rename ship item constants to the tier-variant convention
...
- Updated dependencies [577061a]
  - @shipload/item-renderer@1.0.0-next.59
  - @shipload/sdk@1.0.0-next.59
...
- 9d4d692: - Mirror the roster ladder adoption in the SDK and item-renderer
  ...
  - Include colocated src tests in the SDK test target
  - Sync catalog for the refined T2 ship entry recipes
- Updated dependencies [9d4d692]
  - @shipload/item-renderer@1.0.0-next.58
  - @shipload/sdk@1.0.0-next.58
...
- Updated dependencies [aec43cb]
  - @shipload/item-renderer@1.0.0-next.57
  - @shipload/sdk@1.0.0-next.57
...
- Updated dependencies [bcc59b3]
  - @shipload/item-renderer@1.0.0-next.56
...
- Updated dependencies [53de8db]
  - @shipload/item-renderer@1.0.0-next.55
...
- Updated dependencies [7c6895a]
  - @shipload/item-renderer@1.0.0-next.54
  - @shipload/sdk@1.0.0-next.54

## 1.0.0-next.53

### Patch Changes

- e12e166: - Multi-oracle epoch system
  - Add script to preseed secret
  - Update Dockerfile
  - Migrated shipload/oracle into toolkit
  ...
  - Sync the Assembly Arm recipe
  - Expose Assembly Arm stat mappings
- Updated dependencies [e12e166]
  - @shipload/item-renderer@1.0.0-next.53
  - @shipload/sdk@1.0.0-next.53

## 1.0.0-next.52

### Patch Changes

- 0a6106e: - Surface the builder capability in the CLI and item renderer
...
- d799b49: - Surface the builder capability in the CLI and item renderer
  - Update item-renderer tests for rebalanced formulas and workshop icon
  - Add workshop entity and drop-off craft job support
  - Add roster-expansion ships to SDK catalog and item renderer
  - Refresh item-renderer fixtures for the Ship rename
  ...
  - Update recipe-usage expectations for the T1 ship family
  - Add capacity computation to other ships
- Updated dependencies [0a6106e]
- Updated dependencies [d799b49]
  - @shipload/item-renderer@1.0.0-next.52
...
- Updated dependencies [b68df4a]
  - @shipload/item-renderer@1.0.0-next.51
  - @shipload/sdk@1.0.0-next.51
...
- Updated dependencies [8163b39]
  - @shipload/item-renderer@1.0.0-next.50
...
- Updated dependencies [42fd31e]
  - @shipload/item-renderer@1.0.0-next.49
...
- Updated dependencies [5b7d970]
  - @shipload/item-renderer@1.0.0-next.47
...
- Updated dependencies [130d1bf]
  - @shipload/item-renderer@1.0.0-next.46
...
- Updated dependencies [579f6f7]
  - @shipload/item-renderer@1.0.0-next.45
...
- Updated dependencies [7be0a0d]
  - @shipload/item-renderer@1.0.0-next.44
...
- Updated dependencies [56e5e24]
  - @shipload/item-renderer@1.0.0-next.43
...
- Updated dependencies [039862e]
  - @shipload/item-renderer@1.0.0-next.41
...
- Updated dependencies [74c1205]
  - @shipload/item-renderer@1.0.0-next.40
...
- Updated dependencies [90149b1]
  - @shipload/item-renderer@1.0.0-next.38
...
- Updated dependencies [140c1ed]
  - @shipload/item-renderer@1.0.0-next.37
...
- Updated dependencies [db1e703]
  - @shipload/item-renderer@1.0.0-next.36
...
- Updated dependencies [0adee83]
  - @shipload/item-renderer@1.0.0-next.35
...
- Updated dependencies [2cc3067]
  - @shipload/item-renderer@1.0.0-next.34
...
- Updated dependencies [cb148e2]
  - @shipload/item-renderer@1.0.0-next.33
...
- Updated dependencies [d5d36b3]
  - @shipload/item-renderer@1.0.0-next.32
...
- Updated dependencies [0e659af]
  - @shipload/item-renderer@1.0.0-next.29
...
- Updated dependencies [ef41843]
  - @shipload/item-renderer@1.0.0-next.27
...
- Updated dependencies [bfcb67f]
  - @shipload/item-renderer@1.0.0-next.26
...
- Updated dependencies [26fc4af]
  - @shipload/item-renderer@1.0.0-next.25
...
- Updated dependencies [b541649]
  - @shipload/item-renderer@1.0.0-next.24
...
- Updated dependencies [2f38701]
  - @shipload/item-renderer@1.0.0-next.23
...
- Updated dependencies [a400323]
  - @shipload/item-renderer@1.0.0-next.20
...
- Updated dependencies [c5b0a2f]
  - @shipload/item-renderer@1.0.0-next.19
...
- Updated dependencies [dd9e222]
  - @shipload/item-renderer@1.0.0-next.18
...
- Updated dependencies [c50610d]
  - @shipload/item-renderer@1.0.0-next.17
...
- Updated dependencies [cc2b1e9]
  - @shipload/item-renderer@1.0.0-next.16
...
- Updated dependencies [001e375]
  - @shipload/item-renderer@1.0.0-next.15
...
- Updated dependencies [7a023b9]
  - @shipload/item-renderer@1.0.0-next.14
...
- Updated dependencies [0ab0ad2]
  - @shipload/item-renderer@1.0.0-next.13
